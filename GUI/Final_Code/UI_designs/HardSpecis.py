...
# Form implementation generated from reading ui file 'Hardspecs.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Listofchoices.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.Listofchoices.addItem(item)
    ...
    def retranslateUi(self, Dialog):
        ...
        __sortingEnabled = self.Listofchoices.isSortingEnabled()
        self.Listofchoices.setSortingEnabled(False)
        item = self.Listofchoices.item(0)
        item.setText(_translate("Dialog", "List 1 "))
        item = self.Listofchoices.item(1)
        item.setText(_translate("Dialog", "List 2"))
        self.Listofchoices.setSortingEnabled(__sortingEnabled)
