...
sas5_server.createServer("ServerBlade1", "192.168.4.25", "x86")
...
if redirection: # from user
    ...
    sas5_server.passToExecutors(SASJSONFILEPATH) # template chosen by user
